...
const UpdateBioData = () => {
    ...
    const {name,email,permanent_division, mother_name,height,weight,mobile, dob, biodata_type,_id}= useLoaderData();
        ...
        if (res.data.success) {
            ...
            if (bioRes.data.modifiedCount >0) {
                ...
                Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: `${data.name} Biodata Updated successfully`,
    ...
    return (
        <div>
            <SectionTitle heading ="Update Bio Data"></SectionTitle>
...
<form className="bg-violet-300 ml-10 mb-2 mt-4" onSubmit={handleSubmit(onSubmit)}>
    ...
    <div className="flex gap-2">
        ...
        <div className="form-control w-full  mx-6 ">
            ...
            <select defaultValue={biodata_type} {...register('biodata_type', { required: true })}
    ...
    <div className="flex gap-2">
        <div className="form-control w-full mx-6">
            <label className="label">
                <span className="label-text">Height*in feet</span>
            </label>
            <input
                type="text"
                defaultValue={height}
    ...
    <div className="flex gap-2">
        ...
        <div className="form-control w-full  mx-6 ">
            ...
            <select defaultValue={permanent_division} {...register('permanent_division', { required: true })}
                className="select select-bordered w-full">
